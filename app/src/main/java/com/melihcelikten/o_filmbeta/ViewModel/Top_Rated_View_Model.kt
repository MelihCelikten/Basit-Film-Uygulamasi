...
class Top_Rated_View_Model : ViewModel() {


    val top_rated : Flow<PagingData<Top_Rated_Results>> = Pager(PagingConfig(pageSize = 20)) {
        Top_Rated_Paging_Source(API_SERVICE.create())
